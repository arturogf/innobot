...
module.exports = [
		  function( session, results ) {
		      builder.Prompts.confirm(session,`Perfecto, ¿me podrías decir que tipo de profesional eres? (e.g. residente, enfermero/a, etc.)`);
		  },
		  function( session, results ) {
		  ...
		  function( session, results ) {
		      if (results.response) {
		      session.userData.idea.type.mejora = results.response;
